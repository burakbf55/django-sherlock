...
from .sherlockscripts.sherlock import interpolate_string, sherlock, main
...
from .sherlockscripts.result import QueryStatus
from .sherlockscripts.result import QueryResult
from .sherlockscripts.notify import QueryNotifyPrint
from .sherlockscripts.sites import SitesInformation
...
def sherlock_index(request,
             tor=False, unique_tor=False,
             proxy=None, timeout=None):
    form = SherlockForm()
    if request.method == "POST":
        form = SherlockForm(request.POST)
        if form.is_valid():
            ...
            # return HttpResponseRedirect(reverse('sherlock_index'))
